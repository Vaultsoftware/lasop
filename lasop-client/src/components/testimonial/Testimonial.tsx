        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/60">
              <h5 className="font-semibold text-xl md:text-2xl text-gray-800 mb-4 flex items-center">
              ...
              <ul className="space-y-4">
                {problems.map((problem, index) => (
                  <li
                    key={index}
                    className={`flex items-start transform transition-all duration-700 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-8 opacity-0'
                      }`}
