              ...
              <div className="space-y-3 mb-8">
                {courses.map((course) => (
                  <div key={course.id} className="transition-all duration-300">
                    ...
                    <div 
                      className={`flex items-center p-4 bg-slate-700/50 rounded-lg border-l-4 ${course.borderColor} cursor-pointer hover:bg-slate-700/70 transition-all duration-200 group relative`}
                    ...
                    >
                      ...
                      <div 
                        className="expand-toggle text-slate-400 ml-4 transition-transform group-hover:scale-110 p-2 hover:bg-slate-600/50 rounded cursor-pointer"
