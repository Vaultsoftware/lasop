                ...
                <div className='grid gap-5'>
                    {
                        cohortAd.slice(0, 3).map((coh, ind) => (
                            <div key={ind} className="next_cohort grid md:grid-cols-2 items-center px-[20px] py-[30px] rounded-[5px] border border-accent w-fit mx-auto shadow-lg shadow-shadow">
            ...
            <section className='md:main py-[3rem] px-[30px] bg-secondary'>
                <div className="testimonial">
                    <div className="testimonial_head mb-[2rem] flex flex-col items-center">
                        <h1 data-aos="fade-down" className='font-bold text-[40px] text-center text-shadow'>What Our Students Say</h1>
                        <Image src={outline} alt="" />
                    </div>
                    <div className="testimonial_body grid md:grid-cols-3 xsm:grid-cols-2 gap-6">
                        {
                            testimony.map((test) => (
                                <div data-aos="fade-left" key={test.id} className="testimonial_list p-6 rounded-md bg-primary" style={{ boxShadow: `6px 6px 0 ${test.color}` }}>
                                    <div className="testimonial_author mb-3">
                                        <h3 className='head3' style={{ borderBottom: `2px solid ${test.color}`, width: 'fit-content' }}>{test.name}</h3>
                                    </div>
                    ...
                    <Link data-aos="fade-up" className='flex px-3 w-fit h-[40px] bg-shadow text-cyan-50 items-center justify-center rounded-md mt-5 ml-auto' href='https://g.co/kgs/MCvF7Tq'>View More Reviews</Link>
                </div>
            </section>
                            ...
                            >
                                ...
                                >
                                    <div className="flex items-center gap-4 flex-1 min-w-0">
                                        <div className={`p-3 rounded-xl transition-all duration-300 ${openFaq.includes(index)
                                    ...
                                    <ChevronDown
                                        className={`w-6 h-6 text-[#3360FF] transition-transform duration-300 flex-shrink-0 ${openFaq.includes(index) ? 'rotate-180' : ''
                                            }`}
                                    />
                                </button>

                                {/* Answer Content */}
                                <div className={`overflow-hidden transition-all duration-300 ${openFaq.includes(index) ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
                                    }`}>
                    ...
                    <div className="mt-12 sm:mt-16 text-center">
                        <div className="bg-gradient-to-r from-[#3360FF] to-[#4a6bff] rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 text-white shadow-2xl">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                                <Link href="/contact" className="bg-white text-[#3360FF] px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                                    📞 Book a Call
                                </Link>
                                <Link href="/contact" className="border-2 border-white/30 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg hover:bg-white/10 transition-all duration-300 backdrop-blur-sm">
                                    💬 Live Chat
                                </Link>
                            </div>
                        </div>
            ...
            <section className='md:main py-[3rem] px-[30px] bg-secondary'>
                <div className="programs">
                    <div className="program_head mb-[2rem] flex flex-col items-center">
                        <h1 data-aos="fade-down" className='font-bold text-[40px] text-center'>Our Programs are designed to prepare you for a career in the world's fastest growing industries</h1>
                    </div>
                    <div className="program_info grid md:gap-12 gap-6">
                        {
                            programs.map((pro, ind) => (
                                <div data-aos="fade-right" key={pro.order} className={`program_list grid md:flex ${ind % 2 == 0 ? '' : 'flex-row-reverse'} md:w-[70vw] w-full md:mx-auto mx-0`}>
                                    ...
                                    <div className={`${ind % 2 == 0 ? 'left-[-3rem]' : 'left-[3rem]'} program_info border-2 border-shadow grid md:flex items-center gap-5 py-[20px] md:px-[60px] px-5 md:relative md:top-[1rem] w-full md:w-[70%]`}>
