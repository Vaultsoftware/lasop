...
function OverviewMain() {
  ...
  const colleague: Colleagues[] = [
    ...
    },
    {
      ...
      numCol: cohort.filter((coh) => coh.status === 'completed').length,
      icon: complete,
    },
    { id: 7, title: 'New applicants', numCol: applicants.length, icon: newApp },
    ...
    <main className='w-full p-5'>
      ...
      <div className="staff_info grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div
          ...
          title="Post, edit, and delete blog posts"
        ...
        >
          ...
          <div className='flex justify-between items-center'>
            ...
            <div className="staff_icon">
              <Image className='w-[30px] h-[30px]' src={courses} alt='Manage blog' />
            </div>
          </div>
        </div>
