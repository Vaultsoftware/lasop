'use client';
import { Calendar, Clock, Users, Video, CheckCircle, ArrowRight, Bell, Award, BookOpen, Target, Sparkles } from 'lucide-react';
      ...
      <div className="py-12 lg:py-16 bg-white">
        <div className="md:px-12 px-[30px]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Speaker 1 - Mr. David */}
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-xl shadow-sm border border-blue-100 hover:shadow-lg transition-shadow">
              <div className="w-24 h-24 bg-blue-200 rounded-full flex items-center justify-center mx-auto mb-4 overflow-hidden">
                <img 
                  src="https://ui-avatars.com/api/?name=David&size=200&background=3b82f6&color=fff&bold=true" 
                  alt="Mr. David"
                  className="w-full h-full object-cover"
                />
              </div>
              <h3 className="text-lg font-bold text-gray-900 text-center mb-1">Mr. David</h3>
              <p className="text-xs text-blue-600 text-center font-semibold mb-3">Industry Expert</p>
              <p className="text-sm text-gray-600 text-center">
                Expert in professional development with over 10 years of experience helping professionals achieve their career goals
              </p>
            </div>

            {/* Speaker 2 - Mr. Godswill */}
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-xl shadow-sm border border-blue-100 hover:shadow-lg transition-shadow">
              <div className="w-24 h-24 bg-blue-200 rounded-full flex items-center justify-center mx-auto mb-4 overflow-hidden">
                <img 
                  src="https://ui-avatars.com/api/?name=Godswill&size=200&background=3b82f6&color=fff&bold=true" 
                  alt="Mr. Godswill"
                  className="w-full h-full object-cover"
                />
              </div>
              <h3 className="text-lg font-bold text-gray-900 text-center mb-1">Mr. Godswill</h3>
              <p className="text-xs text-blue-600 text-center font-semibold mb-3">Lead Speaker</p>
              <p className="text-sm text-gray-600 text-center">
                Specializes in career strategy and skill development, guiding thousands to success in their professional journeys
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-xl shadow-sm border border-blue-100 hover:shadow-lg transition-shadow">
              <div className="w-24 h-24 bg-blue-200 rounded-full flex items-center justify-center mx-auto mb-4 overflow-hidden">
                <img 
                  src="https://ui-avatars.com/api/?name=Kevin&size=200&background=3b82f6&color=fff&bold=true" 
                  alt="Mr. Kevin"
                  className="w-full h-full object-cover"
                />
              </div>
              <h3 className="text-lg font-bold text-gray-900 text-center mb-1">Mr. Kevin</h3>
              <p className="text-xs text-blue-600 text-center font-semibold mb-3">Training Specialist</p>
              <p className="text-sm text-gray-600 text-center">
                Passionate about empowering individuals with practical skills and actionable insights for career advancement
              </p>
            </div>
          </div>
        ...
        <div className="md:px-12 px-[30px]">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-white">
            <div>
              ...
              <p className="text-xs lg:text-sm text-blue-200">Registered</p>
            </div>
            <div>
              <div className="text-2xl lg:text-3xl font-bold mb-1">4.9★</div>
              <p className="text-xs lg:text-sm text-blue-200">Rating</p>
            </div>
            <div>
              <div className="text-2xl lg:text-3xl font-bold mb-1">15+</div>
              <p className="text-xs lg:text-sm text-blue-200">Days Left</p>
            </div>
            <div>
              <div className="text-2xl lg:text-3xl font-bold mb-1">100%</div>
              <p className="text-xs lg:text-sm text-blue-200">Free</p>
            </div>
          </div>
        </div>
      </div>
            ...
            {!registered ? (
              <div className="p-6 lg:p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600">
                    Join 500+ professionals already registered
                  </p>
                </div>
                ...
                <form onSubmit={handleRegistration} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={sending}
                    className="w-full bg-blue-700 hover:bg-blue-800 disabled:bg-blue-400 disabled:cursor-not-allowed text-white px-6 py-3 rounded-lg font-bold text-base transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group mt-5"
                  >
                    {sending ? (
                      <>
              ...
              <div className="p-6 lg:p-8 text-center">
                ...
                <p className="text-xs text-gray-500 mt-5">
                  See you on February 22nd at 12:00 PM WAT! 👋
                </p>
              </div>
            )}
          </div>
